...
// Stage A (RECONCILED inputs) — konto 10828174, domyslnie dzien 19.03.2026:
// - nie modyfikuje produkcyjnych CSV
// - tworzy pliki:
//   * DailySessionDeals10828174_RECONCILED.csv
//   * DailySessionSummary_RECONCILED_10828174_<dd-mm-yyyy>.csv
//   * DailySessionReconcile_MT5_CHECK_10828174_<dd-mm-yyyy>.txt (agregaty z historii do porownania z raportem)
//
